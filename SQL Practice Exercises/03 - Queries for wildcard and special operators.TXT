...
11. Write a SQL statement to find those salesmen with all information whose name containing the 1st character is 'N' and the 4th character is 'l' and rests may be any character.  Go to the editor
SELECT *
FROM salesman
WHERE name like 'N__l%'

12. Write a SQL statement to find those rows from the table testtable which contain the escape character underscore ( _ ) in its column 'col1'.  Go to the editor
select *
from testtable
where col1 like '%\_%'
...
13. Write a SQL statement to find those rows from the table testtable which does not contain the character underscore ( _ ) in its column 'col1'.  Go to the editor
SELECT distinct *
FROM testtable
...
15. Write a SQL statement to find those rows from the table testtable which does not contain the escape character ( / ) in its column 'col1'.  Go to the editor
SELECT distinct *
FROM testtable
WHERE col1 NOT LIKE '%\/%'
...
19. Write a SQL statement to find those rows from the table testtable which does not contain the character ( % ) in its column 'col1'.  Go to the editor
SELECT DISTINCT *
FROM testtable
...
22. Write a query in SQL to display all the data of employees whose last name begins with an 'D'. Go to the editor
SELECT *
FROM emp_details
