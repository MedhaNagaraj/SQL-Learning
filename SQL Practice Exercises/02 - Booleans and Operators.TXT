...
a) This query gives the boolean whether it is achieved or not, indicating 0 or 1
SELECT ord_no, purch_amt, purch_amt >3000 as achieved, purch_amt < 3000 as unachieved
FROM orders

b) This gives the percentage:
